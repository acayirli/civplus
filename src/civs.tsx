...
export const civs: { [leader: string]: CivModel } = {
    ...
    johnCurtin: {
        ...
        strength: 3,
        difficulty: 2,
        labels: ["Versatile", "Science", "Naval"],
        strategies: [
            "You can do any opening.",
    ...
    peter: {
        ...
        strength: 3,
        difficulty: 1,
        labels: ["Religion", "Wide", "Culture", "Beginner-friendly"],
        strategies: [
            "Standard holy site opening.",
    ...
    philip: {
        ...
        strength: 3,
        difficulty: 2,
        labels: ["Naval", "Religion", "Gold", "Production"],
        strategies: [
            "Standard holy site opening.",
            "Go into harbors.",
    ...
    tamar: {
        ...
        strength: 2,
        difficulty: 2,
        labels: ["Religion", "Versatile", "Diplomatic"],
        strategies: [
    ...
    teddy: {
        ...
        strength: 3,
        difficulty: 3,
        labels: ["Versatile", "Religion", "Diplomatic"],
        strategies: [
